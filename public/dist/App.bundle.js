...
function ajaxHeart(e) {
	...
	_axios2.default.post(this.action).then(function (res) {
		var isHearted = _this.heart.classList.toggle('heart__button--hearted'); // this.heart gives our button via the name attr 
...
function typeAhead(search) {
	...
	searchInput.on('input', function () {
		...
		// bling bullshit for addEventListener
		...
		_axios2.default.get('/api/search?q=' + this.value).then(function (res) {
			...
			searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result">Sorry no results found for ' + _this.value + '</div>');
		}).catch(function (err) {
			console.error(err);
		});
	});
	...
	searchInput.on('keyup', function (e) {
		...
		var current = search.querySelector('.' + activeClass); // same as 'search__results--active'
		...
		if (e.keyCode === 40 && current) {
			...
			// someone hits enter and there is a current element with href on it
...
var heartForms = (0, _bling.$$)('form.heart'); // querySelectorAll
